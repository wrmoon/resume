...
* Open mindedness:
   ...
   * I empower my teams to speak their minds and disagree respectfully.
...
* STL, VTune, pytest, PyUnit, PHPUnit, NUnit, junit
* VMware, Jenkins, git, Perforce, Jira, Virtual Machines
...
* Helped the team to improve their design techniques, testing shift-left, embracing TDD, SOLID principles and design patterns.
* Hosted "design katas" for team to grow and hone collaborative design skills.
* Tech stack: Java, Hibernate, Oracle, Swing, Spring Boot, Ant, Maven, Gradle, junit, Splunk, Python.
...
* Tech stack: DataDog APM, Akamai, PHP, Symfony, Python, Ubuntu, mySQL, memcached
...
* Tech stack: PHP, Symfony, Python, Ubuntu, mySQL, memcached, Kafka

### Datto, Rochester, NY - Staff Software Engineer 2
#### Sep 2019 - Apr 2020
* Led a scrum team focused on User management, authentication, authorization and SSO for Datto products.
...
* Conducted interviews for engineering candidates.
* Tech stack: PHP, Python, Symfony, phpunit, Ubuntu, mySQL, memcached, Kafka
...
* Conducted interviews for engineering candidates.
* Tech stack: PHP, Python, Symfony, OpenWRT, Kafka, Redis, Cassandra, mySQL

### Kodak Alaris, Rochester, NY - Lead Software Developer
#### Jan 2015 - Sep 2015
* Led 4 other developers to add Ethernet and Wifi network connectivity to an existing USB-based scanner.
...
* Added a suite of unit tests for web service using NUnit.
* Created a consolidated library for database access to eliminate redundant code.
...
* Designed and contributed to the development of a Python-based distributed build system using dedicated build machines
  and a user-friendly web-based interface. The build system was widely adopted by multiple teams in DI, and builds are
  performed on native OS.
...
* Wrote image-processing library from scratch to do rotation, mirroring, matrix operations and 3D lookup tables for
  Noritsu S1200 film scanner.
* Wrote an Arcnet packet analyzer to reverse-engineer Noritsu film gates.
* Was responsible for design and implementation of numerous systems in scanner interface software.
* Wrote low-level scanner interface in C++ for film scanners, including image rotation code in MMX assembly language.
...
### Telog Instruments, Rochester, NY - Firmware Developer
#### Sep 1995 – Sep 1999
* Designed and implemented firmware code in C and assembly language for remote data loggers.
...
* Created company intranet and integrated corporate web site with intranet and version control system.  Administered
  various company servers, coordinated backups.  Helped other employees with computer problems, installed
...
### Redcom Laboratories, Victor, NY - Software Developer
#### Sep 1993 - Sep 1995
* Implemented features for central office product line, including calling number delivery, speed dialing upgrades, call
  trace/call trap. Development done in C, RML and VAX Macro language.

### Redcom Laboratories, Victor, NY - Hardware Engineer
#### Sep 1991 - Sep 1993
...
## Education
* Coursework for Master of Science - Computer Science. Rochester Institute of Technology, Sep 1993 - Sep 1999
* Bachelor of Science - Electrical Engineering. Rochester Institute of Technology, Sep 1986 - Mar 1992
* Regents Diploma. Cincinnatus Central School, Sep 1982 - Jun 1986 (Valedictorian)
