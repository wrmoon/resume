...
* git, VMWare, Perforce, ClearCase, MS Project, InstallShield, MS Office
</div>
...
* Datto DNA is a cloud-based router product. Firmware is built on OpenWRT with multiple 
</div>

<div>
### 2015: Kodak Alaris Inc
#### Lead Software Developer - Scanner WiFi Project
* Lead four other developers to add Ethernet and Wifi network connectivity to an existing USB-based scanner.New
  functionality was delivered using a custom board, similar to a Beagle Bone Black development board.
